...
import com.arkondata.slothql02.cypher.CypherFragment.Expr
import com.arkondata.slothql02.cypher.syntax.{ Graph, Match }
...
object Exists {
  def impl(c: whitebox.Context)(pattern: c.Expr[Graph => Unit]): c.Expr[Expr.Exists] = {
    ...
    c.Expr(q"_root_.com.arkondata.slothql02.cypher.CypherFragment.Expr.Exists($pat)")
  }
}
