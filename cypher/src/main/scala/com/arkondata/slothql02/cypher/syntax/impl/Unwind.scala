...
import com.arkondata.slothql02.cypher.CypherFragment.{ Expr, Known, Query }
import com.arkondata.slothql02.cypher.syntax.Match
...
object Unwind {
  ...
  def instanceImpl[A: c.WeakTypeTag, R: c.WeakTypeTag]
    ...
    val rowExprTree = q"_root_.com.arkondata.slothql02.cypher.CypherFragment.Expr.Var[${weakTypeOf[A]}]($paramName)"
