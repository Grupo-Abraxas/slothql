...
import com.arkondata.slothql.cypher.CypherFragment.{ Expr, Known, Query }
import com.arkondata.slothql.cypher.syntax.Match
...
object Unwind {
  ...
  def instanceImpl[A: c.WeakTypeTag, R: c.WeakTypeTag]
    ...
    val rowExprTree = q"_root_.com.arkondata.slothql.cypher.CypherFragment.Expr.Var[${weakTypeOf[A]}]($paramName)"
